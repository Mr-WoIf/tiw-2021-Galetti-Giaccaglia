...
public class ExamDAO {
	...
	public List<Exam> getSubscribedExamsByStudentID(int studentId, int courseId) throws SQLException {
		...
		String query = "SELECT unidb.exam_register.student_id, unidb.exam_register.exam_id, unidb.exam.course_id, unidb.exam.id, unidb.exam.date " 
				+ "FROM unidb.exam_register JOIN unidb.exam "
				+ "ON exam_register.exam_id = exam.id "
